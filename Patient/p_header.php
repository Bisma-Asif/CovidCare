      <header class="header">
        ...
        <div class="header-right">
          ...
          <button onclick="window.location.href='#notification'" class="icon-btn" title="Notifications"><i class="fa-regular fa-bell"></i></button>
        ...
        <?php echo substr($firstname, 0, 1) . substr($lastname, 0, 1); ?>
         ...
         <div class="header-profile-name">
           <span><?php echo $firstname . ' ' . $lastname; ?> <i class="fa fa-angle-down" aria-hidden="true"></i></span>
        </div>
